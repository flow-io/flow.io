/**
*
*	STREAM: extreme outliers
*
*
*
*	DESCRIPTION:
*		- Filters a data stream for extreme outliers.
*
*
*	API:
*		- 
...
(function() {
	...
	function filter( FLG ) {
		...
		*/
		return function filter( data ) {
			...
			bounds[ 0 ] = qValues[ 0 ] - ( 3*iqr );
			bounds[ 1 ] = qValues[ 1 ] + ( 3*iqr );
	...
	*/
	Stream.prototype.stream = function() {
		...
		// Create a transform stream to filter for extreme outliers:
		oStream = transformer( filter( this._index ) );
