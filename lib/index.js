...
(function() {
	...
	* Array streams.
	*/
	flow.array = require( './streams/array' );
	...
	*/
	...
	flow.covariance = require( './streams/stats/covariance' );
	flow.histc = require( './streams/stats/histc' );
	flow.iqr = require( './streams/stats/iqr' );
	...
	flow.pcc = require( './streams/stats/pcc' );
	...
	* Filter streams.
	*/
	flow.outliers = require( './streams/filter/outliers' );
	flow.mOutliers = require( './streams/filter/outliers/mild.js' );
	flow.eOutliers = require( './streams/filter/outliers/extreme.js' );
	flow.find = require( './streams/find' );
