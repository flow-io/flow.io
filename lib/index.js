...
(function() {
	...
	* Array streams.
	*/
	flow.array = require( './array' );

	/**
	* Reduce streams.
	*/
	flow.reduce = require( './reduce' );

	/**
	* Transform streams.
	*/
	flow.transform = require( './transform' );

	/**
	* Statistics streams.
	*/
	flow.count = require( './stats/count' );
	...
	flow.max = require( './stats/max' );
	flow.mean = require( './stats/mean' );
	flow.median = require( './stats/median' );
	flow.min = require( './stats/min' );
